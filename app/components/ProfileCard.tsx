      ...
      <div className="md:row-span-2 md:col-span-1 bg-dark-blue rounded-2xl ">
        ...
        >
          ...
          >
            ...
            >
              <p className="col-span-4 md:mt-4 md:col-span-2 text-pale-blue text-xs">
                Report for
              </p>

              <p className="whitespace-nowrap md:whitespace-normal col-span-4 md:col-span-2 text-md md:text-4xl font-bold md:font-extralight">
                Jeremy Robson
              </p>
            </motion.div>
          </motion.div>
